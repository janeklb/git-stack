...
func TestChooseSubmitCleanSwitchTargetUsesNextOnClean(t *testing.T) {
	...
	target, proceed, used, err := chooseSubmitCleanSwitchTarget(state, "feat-one", "feat-two", strings.NewReader(""), &out, submitCleanupTargetGitStub{local: map[string]bool{"feat-two": true}})
	if err != nil {
...
func TestChooseSubmitCleanSwitchTargetRejectsMissingNextOnClean(t *testing.T) {
	...
	_, _, used, err := chooseSubmitCleanSwitchTarget(state, "feat-one", "feat-two", strings.NewReader(""), io.Discard, submitCleanupTargetGitStub{})
	if err == nil {
...
func TestChooseSubmitCleanSwitchTargetRejectsCurrentBranchTarget(t *testing.T) {
	...
	_, _, _, err := chooseSubmitCleanSwitchTarget(state, "feat-one", "feat-one", strings.NewReader(""), io.Discard, submitCleanupTargetGitStub{local: map[string]bool{"feat-one": true}})
	if err == nil {
